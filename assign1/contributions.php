...
<body class="ash_body">
	...
	<div class="ash_box">
		<div class="ash_modal_container" id="chinaberrycomment">
			<div class="ash_modal">
				...
				<div class="ash_comment_box">
					<form>
					  <textarea name="ash_comment_boxx" cols="30" rows="10">Add a comment</textarea>
	...
	<footer>
		...
		<div class="dld_footer_section_2">
			<p class="dld_footer_section_2_copyright">Copyright © 2023 <a href="index.html">FLORASCAN. </a>All rights
				reserved.</p>
		</div>
	</footer>
</body>
