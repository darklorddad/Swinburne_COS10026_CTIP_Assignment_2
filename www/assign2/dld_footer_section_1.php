<?php echo '
            <div class = "dld_footer_section_1_left">
                <h1 class = "dld_footer_section_1_left_title"><a href = "index.php">FLORASCAN</a></h1>
                <p class = "dld_footer_section_1_left_title_text">Unearth, delve and spread the wonder of untamed plant life, in natures grand show.</p>
            ...
            <div class = "dld_footer_section_1_center">
                ...
                <div class = "dld_footer_section_1_center_row">
                    <div class = "dld_footer_section_1_center_column">
                        <a href = "explore.php">Families</a>
                        <a href = "genera.php">Genera</a>
                        <a href = "species.php">Species</a>
                        <a href = "profile_ash.php">Profile ASH</a>
                        <a href = "profile_czy.php">Profile CZY</a>
